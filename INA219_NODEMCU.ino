...
#define BLYNK_TEMPLATE_NAME "Power Consumption"
#define BLYNK_AUTH_TOKEN "Dnv1_KThS9cJM1NfwbDPCsR0aziSssyB"
...
void ina219values()  {
  ...
  Blynk.virtualWrite(V5, String("Ksh.") + String(energyPrice) );
  ...
  Serial.print("Energy Cost:   "); Serial.print("Ksh. "); Serial.println(energyCost);
  Serial.println("-------------------------");
}
void displaydata() {
  display.clearDisplay();
  ...
  // ENERGY COST
  Blynk.virtualWrite(V6, String("Ksh.") + String(energyCost, 5) );
